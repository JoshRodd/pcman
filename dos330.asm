...
b7c39:		mov	ss,ax		; 07c39 8ED0
		assume	ss:_BOOTSECT
d7c3b		label	byte
b7c3b:		mov	sp,offset stack_top		; 07c3b BC007C
...
b7c7e:		mov	d7c3f,ax		; 07c7e A33F7C
b7c81:		mov	d7c37,ax		; 07c81 A3377C
...
b7cfa:		sub	al,d7c3b		; 07cfa 2A063B7C
...
b7d48:		mov	d7c3b,dl		; 07d48 88163B7C
b7d4c:		xor	dx,dx		; 07d4c 33D2
b7d4e:		div	heads		; 07d4e F7361A7C
b7d52:		mov	b7c2a,dl		; 07d52 88162A7C
b7d56:		mov	d7c39,ax		; 07d56 A3397C
...
ibmbio_str	db	'PCMAN   COM'
ibmdos_str	db	11 dup (0)
