...
_IVT		ends
		...
		; Now at 4C5h.
_LOAD_TRACKS	segment	at 04Eh
_LOAD_TRACKS_SEG equ	04Eh
bootstrap3_img	label	far
track1		db	1000h dup (?)	; 00500 - 005FF
track2		db	1000h dup (?)	; 01500 - 024FF
track3		db	1000h dup (?)	; 02500 - 034FF
track4		db	1000h dup (?)	; 03500 - 044FF
track4_top	label	byte		; 04500
_LOAD_TRACKS	ends

;_DATA_IMG	segment	at 14Eh
_DATA_IMG	segment	at 0fdh	; 14Eh - (4E0h / 16) - (30h / 16)
_DATA_IMG	ends
...
l145E:		;mov	si,offset intro_music	; 0000145E BEE604
l1461:		;mov	bp,112h			; 00001461 BD1201
		mov	bp,2
music_loop:	mov	ah,0			; 00001464 B400
...
l149B:		jnz	music_loop		; 0000149B 75C7
music_done:
		nop
		nop
		; Delay 3 ticks
...
l1685:		mov	si,offset img_source	; 00001685 BE591F
...
l1F2B:		shl	di,1			; 00001F2B D1E7
		; DI = DI + AX => DI = AX * 4 + AX => DI = AX * 5
l1F2D:		add	di,ax			; 00001F2D 03F8
		; DI = DI * 128 => DI = AX * 5 * 128 => DI = AX * 640
...
l1F3D:		neg	di			; 00001F3D F7DF
		; DI = DI + 8635 => DI = 8635 - AX*640
l1F3F:		add	di,21bbh			; 00001F3F 81C7BB21
l1F43:		mov	si,offset img_source	; 00001F43 BE591F
		; Offets for odd/even switching
		; DX switches from even to odd field (2000h - 8)
		; BP switches from odd to even and advances to next line
l1F46:		mov	dx,1ffch			; 00001F46 BAFC1F
l1F49:		mov	bp,0e04ch			; 00001F49 BD4CE0
		; 14 rows
l1F4C:		mov	cx,0eh			; 00001F4C B90E00
		; Copy 4 bytes (16 PELs)
...
d302f		db	000h	; 00000000b . 059ef 00
		...
		db	4e0h-30h+30h dup (0aah)

_DATA		ends
_TRKS_4_12	segment	para public 'ZZZ'
		db	((12-4+1)*8*512) dup (0f6h)
_TRKS_4_12	ends
_TRKS13_26	segment	para public 'ZZZ'
		db	((26-13+1)*8*512) dup (0f6h)
_TRKS13_26	ends

_TRKS27_39	segment	para public 'ZZZ'
		db	((39-27+1)*8*512) dup (0f6h)
_TRKS27_39	ends
