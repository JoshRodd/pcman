...
l0001: db 0x90                               ; nop                                 
l0002: db 0x90                               ; nop                                 
l0003: db 0xE8,0xCA,0x0F                     ; call 0xfd0                          
l0006: db 0xB8,0x00,0xB8                     ; mov ax,0xb800                       
l0009: db 0x8E,0xC0                          ; mov es,ax                           
l000B: db 0xB0,0x4F                          ; mov al,0x4f                         
l000D: db 0xE6,0x61                          ; out byte 0x61,al                    
l000F: db 0xB0,0xB6                          ; mov al,0xb6                         
l0011: db 0xE6,0x43                          ; out byte 0x43,al                    
l0013: db 0xB8,0x04,0x00                     ; mov ax,0x4                          
l0016: db 0xCD,0x10                          ; int byte 0x10                       
l0018: db 0xBA,0xD9,0x03                     ; mov dx,0x3d9                        
l001B: db 0xB0,0x10                          ; mov al,0x10                         
l001D: db 0xEE                               ; out dx,al                           
l001E: db 0xB2,0x03                          ; mov dl,0x3                          
l0020: db 0xE8,0xEE,0x00                     ; call 0x111                          
l0023: db 0xBF,0x50,0x01                     ; mov di,0x150                        
l0026: db 0xBE,0x00,0x00                     ; mov si,0x0                          
l0029: db 0xBB,0xF4,0xFF                     ; mov bx,0xfff4                       
l002C: db 0xB9,0x17,0x00                     ; mov cx,0x17                         
l002F: db 0xBA,0xF7,0x1F                     ; mov dx,0x1ff7                       
l0032: db 0xBD,0x47,0xE0                     ; mov bp,0xe047                       
l0035: db 0xFC                               ; cld                                 
l0036: db 0xA5                               ; movsw                               
l0037: db 0xA5                               ; movsw                               
l0038: db 0xA5                               ; movsw                               
l0039: db 0xA5                               ; movsw                               
l003A: db 0xA4                               ; movsb                               
l003B: db 0x03,0xFA                          ; add di,dx                           
l003D: db 0x87,0xD5                          ; xchg dx,bp                          
l003F: db 0xE2,0xF5                          ; loop 0x36                           
l0041: db 0x81,0xEF,0x70,0x23                ; sub di,0x2370                       
l0045: db 0x03,0xBF,0xE6,0x04                ; add di,[bx+0x4e6]                   
l0049: db 0x83,0xC3,0x02                     ; add bx,0x2                          
l004C: db 0x75,0xDE                          ; jnz 0x2c                            
...
l0FA9: db 0xC3                               ; ret                                 
l0FAA: db 0x00,0x00                          ; add [bx+si],al                      
l0FAC: db 0x00,0x00                          ; add [bx+si],al                      
l0FAE: db 0x00,0x00                          ; add [bx+si],al                      
l0FB0: db 0xB4,0x00                          ; mov ah,0x0                          
l0FB2: db 0xCD,0x16                          ; int byte 0x16                       
l0FB4: db 0x3C,0x1B                          ; cmp al,0x1b                         
l0FB6: db 0x74,0x01                          ; jz 0xfb9                            
l0FB8: db 0xC3                               ; ret                                 
l0FB9: db 0xB0,0x4D                          ; mov al,0x4d                         
l0FBB: db 0xE6,0x61                          ; out byte 0x61,al                    
l0FBD: db 0xB8,0x03,0x00                     ; mov ax,0x3                          
l0FC0: db 0xCD,0x10                          ; int byte 0x10                       
l0FC2: db 0xB8,0x00,0x4C                     ; mov ax,0x4c00                       
l0FC5: db 0xCD,0x21                          ; int byte 0x21                       
l0FC7: db 0xF4                               ; hlt                                 
l0FC8: db 0x90                               ; nop                                 
l0FC9: db 0x90                               ; nop                                 
l0FCA: db 0x90                               ; nop                                 
...
l0FCE: db 0x90                               ; nop                                 
l0FCF: db 0x90                               ; nop                                 
l0FD0: db 0xCD,0x11                          ; int byte 0x11                       
l0FD2: db 0x24,0x30                          ; and al,0x30                         
l0FD4: db 0x3C,0x20                          ; cmp al,0x20                         
l0FD6: db 0x75,0xEA                          ; jnz 0xfc2                           
l0FD8: db 0xC3                               ; ret                                 
l0FD9: db 0x90                               ; nop                                 
l0FDA: db 0x90                               ; nop                                 
l0FDB: db 0x90                               ; nop                                 
